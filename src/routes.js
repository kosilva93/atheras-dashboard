...
const Station = React.lazy(() => import('./views/pages/station/Station'));
...
const routes = [
  ...
  { path: '/reset_password', name: 'Reset Password', component: ResetPassword },
  ...
  { path: '/station/:id', exact: true, name: 'Station', component: Station}
];
